...
public class balanzas extends javax.swing.JFrame {
        ...
        if (!jTFPeso.getText().equals("")){
            ...
            for (int i = 0; i < numPesos; i++) {
                 ...
                 while (aux.equals("")){
                     ...
                     aux=JOptionPane.showInputDialog("pesa "+cont+":");
                 }
                    try{
            ...
            boolean caso_especial=true;
            for (int i = 0; i < numPesos; i++) {
                int aux=pesas[i];
                String res=Integer.toString(aux);
                lista.add(res);
            }
            caso_especial=validar_repeticion(lista);
    ...
    private boolean validar_repeticion(List<String> lista){
       for (int i=0;i<lista.size();i++){
           int aux1=Integer.parseInt(lista.get(i));
           for (int j=0;j<lista.size();j++){
               int aux2=Integer.parseInt(lista.get(j));
                   if (i!=j){
                       if(aux1==aux2){
                            // eliminamos su valor
                                lista.remove(j);
